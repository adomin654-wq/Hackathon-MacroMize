...
const pairs=[['macromize/lib/dish-category.ts','macromize-ios/src/dish-category.ts'],['reference-data/supabase-pilot-catalog.json','macromize/data/supabase-pilot-catalog.json'],['reference-data/supabase-pilot-catalog.json','macromize-ios/src/supabase-pilot-catalog.json'],['macromize/lib/pilot-catalog.ts','macromize-ios/src/pilot-catalog.ts']];
