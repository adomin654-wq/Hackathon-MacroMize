...
type Props = {
 onDiet?:(diet:Targets["diet"])=>void; layout?:'map'|'list'; onLayout?:(layout:'map'|'list')=>void; targets: Targets; matches: Match[]; location: {lat:number;lon:number;current?:boolean}|null;
