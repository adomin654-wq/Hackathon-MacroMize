...
function setup(legacy=false){
 ...
 const exports={};new Function('require','exports',code)(name=>({'cloudflare:workers':{env:{}},'@/lib/guest-db':{database},'@/lib/macromize':domain,'@/data/meals':catalog,'zod':{z},'@/lib/catalog-service':{loadRestaurantCatalog:async()=>({meals:[...catalog.meals,{id:'live-only'}]})}}[name]),exports);
