...
export const macroFields=[{key:'calories',label:'Kcal',hint:'Calories for this meal',max:10000,min:100},{key:'protein',label:'Protein',hint:'Minimum protein in grams',max:700,min:0},{key:'fat',label:'Fat',hint:'Maximum fat in grams',max:500,min:0},{key:'carbs',label:'Carbs',hint:'Maximum carbohydrates in grams',max:2000,min:0}] as const;
