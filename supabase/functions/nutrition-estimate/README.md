...
Local validation: `deno check supabase/functions/nutrition-estimate/index.ts` passed. Successful estimation and review remain untested because of the billing response. Restaurant expansion to 20–30 locations is not yet imported; the apps still use the existing three-restaurant snapshot.
